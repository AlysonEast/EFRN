...
then
 ...
 CASE=prospective_exp_forests_v2

#pick out the first col

sed -n '12551'p  ${OldCASE}.mean.vect.out.std >seed
...
#awk '$3 <= 7.7279005051' ../representativeness/${CASE}.representativeness | wc -l >PADUS_counts_v2
#awk '$3 <= 7.7279005051' ../representativeness/${CASE}.representativeness | awk '{ sum += $3; n++ } END { if (n > 0) print sum / n; else print "NA"; }' >PADUS_values_v2
...
##########################################################################
 ...
 awk '$3 <= 7.7279005051' ./${CASE}_change | wc -l
 awk '$4 <= 7.7279005051' ./${CASE}_change | wc -l
